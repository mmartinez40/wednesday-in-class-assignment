...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { class: @professor.class, name: @professor.name, office: @professor.office, string: @professor.string } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { class: @professor.class, name: @professor.name, office: @professor.office, string: @professor.string } }
