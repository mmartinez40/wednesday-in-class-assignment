...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { Professor_id: @office.Professor_id, building: @office.building, room_number: @office.room_number } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { Professor_id: @office.Professor_id, building: @office.building, room_number: @office.room_number } }
