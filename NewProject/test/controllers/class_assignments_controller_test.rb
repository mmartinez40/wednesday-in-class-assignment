...
class ClassAssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_assignment" do
    assert_difference('ClassAssignment.count') do
      post class_assignments_url, params: { class_assignment: { Professor_id: @class_assignment.Professor_id, course: @class_assignment.course, room_number: @class_assignment.room_number } }
    end
  ...
  test "should update class_assignment" do
    patch class_assignment_url(@class_assignment), params: { class_assignment: { Professor_id: @class_assignment.Professor_id, course: @class_assignment.course, room_number: @class_assignment.room_number } }
